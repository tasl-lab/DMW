...
class LeaderboardEvaluator(object):
    ...
    def _load_and_run_scenario(self, args, config):
        ...
        try:
            ...
            self.agent_instance.setup(args.agent_config, route_date_string, self.traffic_manager, config.scenario_configs)
        ...
        try:
            ...
            self.manager.load_scenario(self.route_scenario, self.agent_instance, config.index, config.repetition_index, args.prompt_type, args.driver_id)
...
def main():
    ...
    parser.add_argument("--driver_id", type=str, required=False)
