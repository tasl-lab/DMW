...
class VLMEncoderConfig:
    ...
    _target_: str = "models.models.encoder.vlm.VLMEncoderModel"
...
class LanguageModelConfig:
    ...
    _target_: str = "models.models.language_model.llm.LLM"
...
class DrivingModelConfig:
    ...
    _target_: str = "models.models.driving.DrivingModel"


@dataclass
class DatasetBaseConfig:
    data_path: str = "data/dmw"
...
class DrivingDatasetConfig:
    _target_: str = "models.dataloader.dataset_driving.Data_Driving"

@dataclass
class DreamerDatasetConfig:
    _target_: str = "models.dataloader.dataset_dreamer.Data_Dreamer"

@dataclass
class QADatasetConfig:
    _target_: str = "models.dataloader.dataset_eval_qa_comm.Data_Eval"

@dataclass
class InstEvalDatasetConfig:
    _target_: str = "models.dataloader.dataset_eval_dreamer.Eval_Dreamer"
...
class DrivingDataModuleConfig:
    ...
    _target_: str = "models.dataloader.datamodule.DataModule"
...
class TrainConfig:
    ...
    wandb_project: Optional[str] = "dmw"
    if debug:
